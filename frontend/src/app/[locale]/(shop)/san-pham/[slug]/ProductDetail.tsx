            ...
            <div className="flex gap-2 flex-wrap">
              {product.images.map((img, i) => (
                <button
                  ...
                  style={{ borderColor: i === activeImg ? "var(--color-brand)" : "transparent" }}
                >
        ...
        <div>
          ...
          {inStock ? (
            <>
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <button
                  ...
                  disabled={adding}
                  className="flex-1 text-white py-3 px-6 rounded-xl font-semibold transition-colors disabled:opacity-50"
              ...
              <button
                ...
                className="w-full py-3 px-6 rounded-xl font-semibold transition-colors border-2"
            ...
            <div className="space-y-3">
              ...
              <button className="w-full border border-gray-300 text-gray-700 py-3 rounded-xl font-medium hover:bg-amber-50 transition-colors">
          ...
          {[
            ...
            <button
              ...
              className={`pb-3 text-sm font-medium border-b-2 transition-colors whitespace-nowrap flex-shrink-0 ${
                activeTab === tab.key ? "" : "border-transparent text-gray-400 hover:text-gray-600"
              }`}
              style={activeTab === tab.key ? { borderColor: "var(--color-brand)", color: "var(--color-brand)" } : undefined}
            >
              {tab.label}
            </button>
          ))}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {product.related_products.map(p => (
              <a key={p.slug} href={`/san-pham/${p.slug}`} className="group block">
                ...
                <p className="text-sm font-medium text-gray-800 group-hover:text-red-700 transition-colors truncate">{p.name}</p>
